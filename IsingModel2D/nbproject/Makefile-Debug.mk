...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/isingmodel2d

${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/isingmodel2d: ${OBJECTFILES}
...
${OBJECTDIR}/IsingLattice2D.o: IsingLattice2D.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/IsingLattice2D.o IsingLattice2D.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/isingmodel2d
