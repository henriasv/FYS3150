...
${OBJECTDIR}/Gauss_Laguerre.o: Gauss_Laguerre.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gauss_Laguerre.o Gauss_Laguerre.cpp

${OBJECTDIR}/Importance_Sampling_MC.o: Importance_Sampling_MC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Importance_Sampling_MC.o Importance_Sampling_MC.cpp

${OBJECTDIR}/Bruteforce_MC.o: Bruteforce_MC.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Bruteforce_MC.o Bruteforce_MC.cpp

${OBJECTDIR}/Gauss_Legendre.o: Gauss_Legendre.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Gauss_Legendre.o Gauss_Legendre.cpp

${OBJECTDIR}/Helium_Solver.o: Helium_Solver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} $@.d
	$(COMPILE.cc) -O2 -MMD -MP -MF $@.d -o ${OBJECTDIR}/Helium_Solver.o Helium_Solver.cpp
